...
public final class PTYProcess: @unchecked Sendable {
    ...
    public init(
        ...
        // TTYBuild terminals advertise full color support. Do not let the
        ...
        // becomes visual noise after remote replay and resize redraws. TTYBuild
