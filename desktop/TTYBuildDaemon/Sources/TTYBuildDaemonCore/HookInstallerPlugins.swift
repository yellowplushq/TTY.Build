...
/// Plugin-based agents whose hook surface is a generated source file TTYBuild
...
/// agent. No env guard is needed: TTYBuild is system-wide.
extension HookInstaller {
    /// Rewrites only generated plugin files that already carry a TTYBuild
    ...
    /// `~/.config/opencode/plugins/ttybuild-presence.js`. OpenCode exposes
    ...
    enum OpenCode {
        ...
        static func path(home: URL) -> String {
            home.appendingPathComponent(".config", isDirectory: true)
                ...
                .appendingPathComponent("ttybuild-presence.js").path
        }
        ...
        static func canonicalData(reporterPath: String) -> Data {
            ...
            let source = """
            \(marker)
            // Generated by tty.build — `ttybuild hooks uninstall opencode` removes this file.
            ...
            export const TTYBuildPresence = async () => {
              return {
    ...
    /// (`~/.omp/agent/extensions/ttybuild/index.ts` /
    /// `~/.pi/agent/extensions/ttybuild/index.ts`); they differ in the import
    ...
    enum PiFamily {
        static let marker = "/* ttybuild-managed-extension */"
        ...
        static func path(home: URL, agent: Variant) -> String {
            home.appendingPathComponent(agent.dotDirectory, isDirectory: true)
                ...
                .appendingPathComponent("ttybuild", isDirectory: true)
        ...
        static func canonicalData(reporterPath: String, agent: Variant) -> Data {
            ...
            let source = """
            \(marker)
            // Generated by tty.build — `ttybuild hooks uninstall \(slug)` removes this file.
            import { spawn } from "node:child_process";
        ...
        static func uninstall(home: URL, agent: Variant) throws {
            ...
            // The extensions/ttybuild/ directory is ours alone — remove it once
